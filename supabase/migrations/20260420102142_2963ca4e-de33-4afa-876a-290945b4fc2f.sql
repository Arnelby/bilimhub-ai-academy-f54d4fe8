...
REVOKE ALL ON FUNCTION public.apply_practice_explanations(jsonb) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.apply_practice_explanations(jsonb) TO service_role;