  ...
  "rounded-xl border transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        gradient: "gradient-bg text-primary-foreground border-0",
        interactive: "bg-card text-card-foreground shadow-md hover:shadow-xl hover:-translate-y-2 cursor-pointer",
        success: "bg-success/10 border-success/30 text-card-foreground",
        warning: "bg-warning/10 border-warning/30 text-card-foreground",
        accent: "bg-accent/10 border-accent/30 text-card-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
